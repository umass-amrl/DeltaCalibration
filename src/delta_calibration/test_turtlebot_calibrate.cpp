...
int main(int argc, char **argv) {
  ...
  ReadUncertaintiesFromFile("generated_uncertaintiest.txt",
                            &uncertaintyT_1, &uncertaintyT_2);

  ReadUncertaintiesFromFile("generated_uncertaintiesr.txt",
                            &uncertaintyR_1, &uncertaintyR_2);

  ReadUncertaintiesFromFile("T_generated_uncertaintiest.txt",
                            &TuncertaintyT_1, &TuncertaintyT_2);

  ReadUncertaintiesFromFile("T_generated_uncertaintiesr.txt",
